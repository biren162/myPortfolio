			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-6">
								<a href="#" class="active" id="login-form-link">password recovery</a>
							</div>
						</div>
						<hr>
					</div>
						...
						<div class="row">
							<div class="col-lg-12">
								...
								<input type="hidden" name="userId" value=${"userId"} />
									...
									<div class="form-group">
										<input type="password" name="password2"  id="password2" tabindex="1" class="form-control" placeholder="re-enter" >
