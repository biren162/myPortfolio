...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCurrIGsqh0q7G6pepNXR1uMsuoXnuk5PM&signed_in=true"
        async defer>
    </script> 
    <div id="mapbiren">
...
function success(position) {
  ...
  document.querySelector('#mapbiren').appendChild(mapcanvas);
